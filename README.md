...
```
After you created the rule as above, please add the rule into the VizGraphRuleEngine.
The rule engine will scan each rule, and check if the rule is applicable.
